...
<body>
    ...
    <script>
        ...
        const entities = [
            ...
            { name: "Lilith", img: "URL_HERE", desc: "A female night spirit from Jewish mythology." },
            { name: "Lamia", img: "URL_HERE", desc: "A half-woman, half-serpent monster from Greek mythology." },
            { name: "Wendigo", img: "URL_HERE", desc: "A spirit of endless hunger from Native American folklore." },
            { name: "Banshee", img: "URL_HERE", desc: "An Irish spirit whose scream foretells death." },
            { name: "Kuyuki", img: "URL_HERE", desc: "A nine-tailed fox spirit from Japanese folklore." },
            { name: "Anubis", img: "URL_HERE", desc: "The guardian of the dead in Ancient Egyptian mythology." },
            { name: "Chupacabra", img: "URL_HERE", desc: "A legendary blood-drinking creature from Latin America." },
            { name: "Kappa", img: "URL_HERE", desc: "A water creature from Japanese folklore that lures people into water." },
            { name: "Dracula", img: "URL_HERE", desc: "A legendary vampire who feeds on human blood." },
            { name: "Vampire", img: "URL_HERE", desc: "A nocturnal being that survives on blood or life energy." },
            { name: "Werewolf", img: "URL_HERE", desc: "A human who transforms into a wolf during the full moon." },
            { name: "Poltergeist", img: "URL_HERE", desc: "A restless spirit known for moving objects and haunting homes." },
            { name: "Succubus", img: "URL_HERE", desc: "A female spirit that seduces men in their sleep." },
            { name: "Incubus", img: "URL_HERE", desc: "The male counterpart of the succubus." },
            { name: "Gremlin", img: "URL_HERE", desc: "A mischievous creature blamed for mechanical failures." },
            { name: "Reaper", img: "URL_HERE", desc: "A cloaked figure associated with death and collecting souls." },
            { name: "Ghoul", img: "URL_HERE", desc: "A graveyard-dwelling creature that feeds on the dead." },
            { name: "Nosferatu", img: "URL_HERE", desc: "An ancient and monstrous form of vampire." },
            { name: "Rakshasa", img: "URL_HERE", desc: "A powerful flesh-eating demon from Hindu mythology." },
            { name: "Pontianak", img: "URL_HERE", desc: "A female ghost from Malaysian folklore." },
